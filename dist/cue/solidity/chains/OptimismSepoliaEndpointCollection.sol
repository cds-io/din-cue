...
contract Deploy is Script {
	...
	function run() external {
		...
		IEndpointCollection ec = api.createEndpointCollection("optimism://sepolia", "EVM-compatible Layer-2 on Ethereum (sepolia)");
		...
		vm.stopBroadcast();
		console2.log("OptimismSepoliaEndpointCollection deployed to: ", address(ec));
	}
}