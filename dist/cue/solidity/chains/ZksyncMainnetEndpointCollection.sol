...
contract Deploy is Script {
	...
	function run() external {
		...
		IEndpointCollection ec = api.createEndpointCollection("zksync://mainnet", "zkSync mainnet network");
		...
		vm.stopBroadcast();
		console2.log("ZksyncMainnetEndpointCollection deployed to: ", address(ec));
	}
}