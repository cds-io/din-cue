...
contract Deploy is Script {
	...
	function run() external {
		...
		IEndpointCollection ec = api.createEndpointCollection("mantle://sepolia", "Mantle Sepolia test network");
		...
		vm.stopBroadcast();
		console2.log("MantleSepoliaEndpointCollection deployed to: ", address(ec));
	}
}