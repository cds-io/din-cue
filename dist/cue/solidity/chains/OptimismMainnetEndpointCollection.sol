...
contract Deploy is Script {
	...
	function run() external {
		...
		IEndpointCollection ec = api.createEndpointCollection("optimism://mainnet", "EVM-compatible Layer-2 on Ethereum (mainnet)");
		uint256 expectedCaps = 0x1fffffffffffe;
		...
		vm.stopBroadcast();
		console2.log("OptimismMainnetEndpointCollection deployed to: ", address(ec));
	}
}