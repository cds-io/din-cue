...
contract Deploy is Script {
	...
	function run() external {
		...
		IEndpointCollection ec = api.createEndpointCollection("blast://testnet", "EVM-compatible Layer-2 on Ethereum");
		...
		vm.stopBroadcast();
		console2.log("BlastTestnetEndpointCollection deployed to: ", address(ec));
	}
}