...
contract Deploy is Script {
	...
	function run() external {
		...
		IEndpointCollection ec = api.createEndpointCollection("ethereum://goerli", "Ethereum Goerli test network");
		...
		vm.stopBroadcast();
		console2.log("EthereumGoerliEndpointCollection deployed to: ", address(ec));
	}
}