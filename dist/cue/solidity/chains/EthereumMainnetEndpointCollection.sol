...
contract Deploy is Script {
	...
	function run() external {
		...
		IEndpointCollection ec = api.createEndpointCollection("ethereum://mainnet", "The main Ethereum network");
		...
		vm.stopBroadcast();
		console2.log("EthereumMainnetEndpointCollection deployed to: ", address(ec));
	}
}