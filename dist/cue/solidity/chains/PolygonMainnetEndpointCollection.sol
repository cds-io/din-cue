...
contract Deploy is Script {
	...
	function run() external {
		...
		IEndpointCollection ec = api.createEndpointCollection("polygon://mainnet", "Polygon POS - An EVM enabled sidechain");
		uint256 expectedCaps = 0x3ffffffffffffffe;
		...
		vm.stopBroadcast();
		console2.log("PolygonMainnetEndpointCollection deployed to: ", address(ec));
	}
}