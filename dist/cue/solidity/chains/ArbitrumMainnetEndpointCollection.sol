...
contract Deploy is Script {
	...
	function run() external {
		...
		IEndpointCollection ec = api.createEndpointCollection("arbitrum://mainnet", "EVM-compatible Layer-2 on Ethereum");
		uint256 expectedCaps = 0x1fffffffffffffe;
		...
		vm.stopBroadcast();
		console2.log("ArbitrumMainnetEndpointCollection deployed to: ", address(ec));
	}
}