...
contract Deploy is Script {
	...
	function run() external {
		...
		IEndpointCollection ec = api.createEndpointCollection("ethereum://sepolia", "Ethereum Sepolia test network");
		...
		vm.stopBroadcast();
		console2.log("EthereumSepoliaEndpointCollection deployed to: ", address(ec));
	}
}