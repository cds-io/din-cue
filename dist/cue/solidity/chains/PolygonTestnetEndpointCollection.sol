...
contract Deploy is Script {
	...
	function run() external {
		...
		IEndpointCollection ec = api.createEndpointCollection("polygon://testnet", "Polygon POS - An EVM enabled sidechain");
		...
		vm.stopBroadcast();
		console2.log("PolygonTestnetEndpointCollection deployed to: ", address(ec));
	}
}